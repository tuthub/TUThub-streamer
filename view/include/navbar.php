       ...
       <div class="top_bar">
            <div class="container">
                <div class="top_header_content">
                    <div class="menu_logo">
                        <a href="#" title="" id="buttonMenu" class="menu" style="">
                            <i class="icon-menu"></i>
                        </a>
                        <script>
                        ...
                        <a href="<?php echo empty($advancedCustom->logoMenuBarURL) ? $global['webSiteRootURL'] : $advancedCustom->logoMenuBarURL; ?>" >
                            <img src="<?php echo $global['webSiteRootURL'], $config->getLogo(true); ?>" alt="<?php echo $config->getWebSiteTitle(); ?>">
                        </a>
                        <?php
                        if (!empty($advancedCustomUser->keepViewerOnChannel) && !empty($_SESSION['channelName'])) {
                            $user = User::getChannelOwner($_SESSION['channelName']);
                        ?>
                        <a class="" href="<?php echo User::getChannelLinkFromChannelName($_SESSION['channelName']); ?>" >
                            <img src="<?php echo User::getPhoto($user['id']); ?>" alt="<?php echo User::getNameIdentificationById($user['id']); ?>" class="img img-responsive img-circle " style="height: 33px; width: 33px; margin-top: 10px;"> 
                        </a>
                        <?php } ?>
                    </div><!--menu_logo end-->
                    <div class="search_form">
                        <form id="" action="<?php echo $global['webSiteRootURL']; ?>" style="margin: 0 !important; width: auto;">
                    ...
                    <ul class="controls-lv">
                        ...
                        ?>
                        <li>
                            <button type="button" class="btn btn-default upload" title=""><i class="glyphicon glyphicon-facetime-video"></i></button>
                            <div class="upload_div" style="padding: 0 0;">
                                <div class="sd_menu">
                                    <?php
                                    ...
                                    <ul class="mm_menu">
                                        ...
                                        if (!empty($advancedCustom->encoderNetwork) && empty($advancedCustom->doNotShowEncoderNetwork)) {
                                            ...
                                            <li>
                                                ...
                                                <a href="#" onclick="$('#formEncoderN').submit();
                                                                        return false;">
                                                     <?php echo empty($advancedCustom->encoderNetworkLabel) ? __("Encoder Network") : $advancedCustom->encoderNetworkLabel; ?>
                                                </a>
                                            </li>
                                            <?php
                                        }
                                            ...
                                            if (!empty($config->getEncoderURL())) {
                                                ...
                                                <li>
                                                    ...
                                                    <a href="#" onclick="$('#formEncoder').submit();
                                                                                return false;">
                                                        <?php echo empty($advancedCustom->encoderButtonLabel) ? __("Encode video and audio") : $advancedCustom->encoderButtonLabel; ?>
                                                    </a>
                                                </li>
                                                <?php
                                            } else {
                                                ...
                                                <li>
                                                    ...
                                                    <a href="<?php echo $global['webSiteRootURL']; ?>siteConfigurations" > <?php echo __("Configure an Encoder URL"); ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        if (empty($advancedCustom->doNotShowUploadMP4Button)) {
                                            ...
                                            <li>
                                                ...
                                                <a  href="<?php echo $global['webSiteRootURL']; ?>mvideos?upload=1" > <?php echo empty($advancedCustom->uploadMP4ButtonLabel) ? __("Direct upload") : $advancedCustom->uploadMP4ButtonLabel; ?>
                                                </a>
                                            </li>
                                            <?php
                                        }
                                        if (empty($advancedCustom->doNotShowImportMP4Button)) {
                                            ...
                                            <li>
                                                ...
                                                <a href="<?php echo $global['webSiteRootURL']; ?>view/import.php" >
                                                     <?php echo empty($advancedCustom->importMP4ButtonLabel) ? __("Direct Import Local Videos") : $advancedCustom->importMP4ButtonLabel; ?>
                                                </a>
                                            </li>
                                            <?php
                                        }
                                        if (empty($advancedCustom->doNotShowEmbedButton)) {
                                            ...
                                            <li>
                                                ...
                                                <a href="<?php echo $global['webSiteRootURL']; ?>mvideos?link=1" >
                                                     <?php echo empty($advancedCustom->embedButtonLabel) ? __("Embed a video link") : $advancedCustom->embedButtonLabel; ?>
                                                </a>
                                            </li>
                                            <?php
                                        }
                        ...
                        <li class="user-log">
                            <div class="user-ac-img">
                                <img src="<?php echo User::getPhoto(); ?>" style="width: 55px; height: 55px;"  class="img img-responsive img-circle">
                            </div>
                            <div class="account-menu" style="padding: 0">
                            <?php if (User::isLogged()) { ?>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 text-right">
                                                    <br>
                                                    <small style="font-size: auto;"><?php echo User::getMail(); ?></small>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <?php if (!$advancedCustomUser->disableSignOutButton) { ?>
                                <div class="sd_menu">
                                    <ul class="mm_menu">
                                        <li>
                                            <span>
                                ...
                                <div class="sd_menu">
                                    <ul class="mm_menu">
                                        <li>
                                            ...
                                            <a href="<?php echo $global['webSiteRootURL']; ?>user" title="">Sign in</a>
                                        </li>
                                    </ul>
                                </div>
                            <?php } ?>
            ...
            <div id="sidebar" class="list-group-item" style="<?php echo $sidebarStyle; ?>top:auto;margin-top:27px;z-index: 1000;">
